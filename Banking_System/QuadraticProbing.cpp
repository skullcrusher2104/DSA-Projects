...
void QuadraticProbing::account_created(){
    size++;
}

void QuadraticProbing::account_deleted(){
    size--;
}

int QuadraticProbing::get_max(std::vector<int>& balances){
    int max=balances[0];
    int max_index=0;
